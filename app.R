...
ui <- page_navbar(
  ...
  nav_panel("Documentation",
            h2("Version History"),
            h4("Active: Version 1.1 [10 Apr 2026]"),
            h5("Release Notes"),
...
server <- function(input, output, session) {
  ...
  layer.titles <- function(col) {
    ...
    if(col == "lapop1") return("Population >1 mile from supermarket (total)")
    if(col == "lapop1share") return("Population >1 mile from supermarket (%)")
    if(col == "lalowi1") return("Low-income population >1 mile from supermarket (total)")
    if(col == "lalowi1share") return("Low-income population >1 mile from supermarket (%)")
    if(col == "lakids1") return("Children age 0-17 population >1 mile from supermarket (total)")
    if(col == "lakids1share") return("Children age 0-17 population >1 mile from supermarket (%)")
    if(col == "laseniors1") return("Age 65+ population >1 mile from supermarket (total)")
    if(col == "laseniors1share") return("Age 65+ population >1 mile from supermarket (%)")
    if(col == "lawhite1") return("White population >1 mile from supermarket (total)")
    if(col == "lawhite1share") return("White population >1 mile from supermarket (%)")
    if(col == "lablack1") return("Black population >1 mile from supermarket (total)")
    if(col == "lablack1share") return("Black population >1 mile from supermarket (%)")
    if(col == "laasian1") return("Asian population >1 mile from supermarket (total)")
    if(col == "laasian1share") return("Asian population >1 mile from supermarket (%)")
    if(col == "lanhopi1") return("Native Hawaiian or Other Pacific Islander population >1 mile from supermarket (total)")
    if(col == "lanhopi1share") return("Native Hawaiian or Other Pacific Islander population >1 mile from supermarket (%)")
    if(col == "laaian1") return("Alaska Native or American Indian population >1 mile from supermarket (total)")
    if(col == "laaian1share") return("Alaska Native or American Indian population >1 mile from supermarket (%)")
    if(col == "laomultir1") return("Other or Multiple race population >1 mile from supermarket (total)")
    if(col == "laomultir1share") return("Other or Multiple population >1 mile from supermarket (%)")
    if(col == "lahisp1") return("Hispanic or Latino population >1 mile from supermarket (total)")
    if(col == "lahisp1share") return("Hispanic or Latino population >1 mile from supermarket (%)")
    if(col == "lahunv1") return("Housing units without a vehicle >1 mile from supermarket (total)")
    if(col == "lahunv1share") return("Housing units without a vehicle >1 mile from supermarket (%)")
    if(col == "lasnap1") return("Housing units receiving SNAP benefits benefits >1 mile from supermarket (total)")
    if(col == "lasnap1share") return("Housing units receiving SNAP benefits benefits >1 mile from supermarket (%)")
  }
  ...
  var.info <- function(col) {
    ...
    if(col == "lapop1") return("Population in a census tract who reside >1 mile from supermarket from the US Department of Agriculture (USDA) Food Access Research Atlas (2021 release)")
    if(col == "lapop1share") return("Percentage population who reside > 1 mile from supermarket from the US Department of Agriculture (USDA) Food Access Research Atlas (2021 release)")
    if(col == "lalowi1") return("Low-income population in a census tract who reside >1 mile from supermarket from the US Department of Agriculture (USDA) Food Access Research Atlas (2021 release)")
    if(col == "lalowi1share") return("Percentage of Low-income population in a census tract who reside >1 mile from supermarket from the US Department of Agriculture (USDA) Food Access Research Atlas (2021 release)")
    if(col == "lakids1") return("Children age 0-17 population in a census tract who reside >1 mile from supermarket from the US Department of Agriculture (USDA) Food Access Research Atlas (2021 release)")
    if(col == "lakids1share") return("Percentage of children age 0-17 population in a census tract who reside >1 mile from supermarket from the US Department of Agriculture (USDA) Food Access Research Atlas (2021 release)")
    if(col == "laseniors1") return("Age 65+ population in a census tract who reside >1 mile from supermarket from the US Department of Agriculture (USDA) Food Access Research Atlas (2021 release)")
    if(col == "laseniors1share") return("Percentage of age 65+ population in a census tract who reside >1 mile from supermarket from the US Department of Agriculture (USDA) Food Access Research Atlas (2021 release)")
    if(col == "lawhite1") return("White population in a census tract who reside >1 mile from supermarket from the US Department of Agriculture (USDA) Food Access Research Atlas (2021 release)")
    if(col == "lawhite1share") return("Percentage White population in a census tract who reside >1 mile from supermarket from the US Department of Agriculture (USDA) Food Access Research Atlas (2021 release)")
    if(col == "lablack1") return("Black or African American population in a census tract who reside >1 mile from supermarket from the US Department of Agriculture (USDA) Food Access Research Atlas (2021 release)")
    if(col == "lablack1share") return("Percentage Black or African American population in a census tract who reside >1 mile from supermarket from the US Department of Agriculture (USDA) Food Access Research Atlas (2021 release)")
    if(col == "laasian1") return("Asian population in a census tract who reside >1 mile from supermarket from the US Department of Agriculture (USDA) Food Access Research Atlas (2021 release)")
    if(col == "laasian1share") return("Percentage Asian population in a census tract who reside >1 mile from supermarket from the US Department of Agriculture (USDA) Food Access Research Atlas (2021 release)")
    if(col == "lanhopi1") return("Native Hawaiian or Other Pacific Islander population in a census tract who reside >1 mile from supermarket from the US Department of Agriculture (USDA) Food Access Research Atlas (2021 release)")
    if(col == "lanhopi1share") return("Percentage Native Hawaiian or Other Pacific Islander population in a census tract who reside >1 mile from supermarket from the US Department of Agriculture (USDA) Food Access Research Atlas (2021 release)")
    if(col == "laaian1") return("American Indian or Alaska Native population in a census tract who reside >1 mile from supermarket from the US Department of Agriculture (USDA) Food Access Research Atlas (2021 release)")
    if(col == "laaian1share") return("Percentage American Indian or Alaska Native population in a census tract who reside >1 mile from supermarket from the US Department of Agriculture (USDA) Food Access Research Atlas (2021 release)")
    if(col == "laomultir1") return("Other or Multiple race population in a census tract who reside >1 mile from supermarket from the US Department of Agriculture (USDA) Food Access Research Atlas (2021 release)")
    if(col == "laomultir1share") return("Percentage Other or Multiple race population in a census tract who reside >1 mile from supermarket from the US Department of Agriculture (USDA) Food Access Research Atlas (2021 release)")
    if(col == "lahisp1") return("Hispanic or Latino ethnicity population in a census tract who reside >1 mile from supermarket from the US Department of Agriculture (USDA) Food Access Research Atlas (2021 release)")
    if(col == "lahisp1share") return("Percentage Hispanic or Latino ethnicity population in a census tract who reside >1 mile from supermarket from the US Department of Agriculture (USDA) Food Access Research Atlas (2021 release)")
  ...
  observeEvent(input$clear_all_vars, {
    ...
    updateSelectInput(session, "micro", selected = character(0))
  ...
  <path d="M15 8a1 1 0 0 0 1-1V5a1 1 0 0 0-1-1V2.64c0-1.188-.845-2.232-2.064-2.372A44 44 0 0 0 8 0C5.9 0 4.208.136 3.064.268 1.845.408 1 1.452 1 2.64V4a1 1 0 0 0-1 1v2a1 1 0 0 0 1 1v3.5c0 .818.393 1.544 1 2v2a.5.5 0 0 0 .5.5h2a.5.5 0 0 0 .5-.5V14h6v1.5a.5.5 0 0 0 .5.5h2a.5.5 0 0 0 .5-.5v-2c.607-.456 1-1.182 1-2zM8 1c2.056 0 3.71.134 4.822.261.676.078 1.178.66 1.178 1.379v8.86a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 2 11.5V2.64c0-.72.502-1.301 1.178-1.379A43 43 0 0 1 8 1"/>
      ...
      for (i in seq_along(colnames(food_env_cols()))) {
        ...
        if (!is.null(pal)) {
          ...
          proxy <- proxy %>% 
            addPolygons(data = food_env_cols(), fillColor = ~pal(x), stroke = TRUE, weight = 0.25, color = "black", group = layer.titles(c_name),
